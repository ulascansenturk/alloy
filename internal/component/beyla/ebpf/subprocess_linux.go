...
// abstractSocketAddr returns a Linux abstract Unix socket address (leading '@', kernel-only).
// Unique across restarts and component instances; fits within sun_path (108 bytes).
